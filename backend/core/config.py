...
class Config:
    ...
    SQLALCHEMY_POOL_SIZE = int(os.environ.get("ASSET_SENTINEL_DB_POOL_SIZE", "2"))
    SQLALCHEMY_MAX_OVERFLOW = int(os.environ.get("ASSET_SENTINEL_DB_MAX_OVERFLOW", "2"))
    SQLALCHEMY_POOL_TIMEOUT = int(os.environ.get("ASSET_SENTINEL_DB_POOL_TIMEOUT", "10"))
    SQLALCHEMY_POOL_RECYCLE = int(os.environ.get("ASSET_SENTINEL_DB_POOL_RECYCLE_SECONDS", "1800"))
